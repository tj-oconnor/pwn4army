...
void logo()
{
    ...
    printf("      .kMMMMMMMMMMMMWNKOdl:,.      ROP2Driv3       .';cdk0XWMMMMMMMMMMMMO'      \n");
...
void authenticate()
{
    char contact[16];
    printf("<<< -----------------------------------------------------------------------------\n");
    printf("<<< Remote Controlled CTF v4.3: Rop2Drive                                        \n");
    printf("<<< -----------------------------------------------------------------------------\n");
    printf("<<< We are sorry, but our car service is not available at this time. DriverMenu()\n");
    printf("<<< has been removed, and car_server_connect is not called o prevent exploitation\n");
    printf("<<< Please provide your email contact info and we'll get back to you ASAP >>> ");
    read(0, &contact, 512);
    printf("<<< Thank you!\n");
    return;
}
